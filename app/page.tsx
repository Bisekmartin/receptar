  ...
  return (
    <div>
      <div className="flex items-end justify-between mb-8">
        <div>
          <h1 className="font-serif text-3xl sm:text-4xl text-stone-800 mb-1">Recepty</h1>
      ...
      {recipes.length === 0 ? (
        <div className="text-center py-24">
          <p className="font-serif text-3xl text-stone-300 mb-4">Receptář je prázdný</p>
          {admin ? (
            <>
              <p className="text-stone-400 mb-8">Začněte přidáním prvního receptu nebo importem.</p>
            ...
            <p className="text-stone-400">Zatím tu nejsou žádné recepty.</p>
          )}
        </div>
      ) : (
